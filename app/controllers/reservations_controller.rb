class ReservationsController < ApplicationController
  ...
  def create
    ...
    if @reservation
      ...
      values = {
        business: 'wthoma390-facilitator@gmail.com',
        cmd: '_xclick',
        upload: 1,
        # replace notify_url with new ngrok
        notify_url: 'http://1c1078c0.ngrok.io/notify',
        amount: @reservation.total,
        item_name: @reservation.room.listing_name,
        item_number: @reservation.id,
        quantity: '1',
        return: 'http://1c1078c0.ngrok.io/your_trips'
      }
